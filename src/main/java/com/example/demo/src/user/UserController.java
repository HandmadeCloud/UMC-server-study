...
public class UserController {
    ...
    public BaseResponse<PostUserRes> createUser(@RequestBody PostUserReq postUserReq) {
        ...
        if (postUserReq.getUserDong() == null) {
            return new BaseResponse<>(POST_USERS_EMPTY_DONG);
        }
...
/**
  ...
  **************************************************************************
 */
            PatchUserReq patchUserReq = new PatchUserReq(userIdx, user.getNickname(), user.getPhoneNum(), user.getPassword(), user.getUserDong(), user.getMannerTemp());
            userService.modifyUserName(patchUserReq);
            userService.modifyUserDong(patchUserReq);
            userService.modifyUserPhoneNum(patchUserReq);
